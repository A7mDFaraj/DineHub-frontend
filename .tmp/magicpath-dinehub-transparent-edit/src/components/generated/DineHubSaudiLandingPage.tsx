...
import heroImage from "../../../assets/dinehub-hero-3d-transparent.png";
const logoImage = "https://storage.googleapis.com/storage.magicpath.ai/component-assets/444810436261584896/444810436265779200/7592a304dfc6259dc8129f75830d9284239f77e55891dd8e9d7aec5df6586fd3.png";
const qrFeature = "https://storage.googleapis.com/storage.magicpath.ai/component-assets/444810436261584896/444810436265779200/01f751a6864118826ace1c0decd46f523db6c501d510947f750789a00abd2206.png";
const customFeature = "https://storage.googleapis.com/storage.magicpath.ai/component-assets/444810436261584896/444810436265779200/53ecf501e73851798f6c41f8e5990e8a611d34f55d8538cdb4f78f369f059fd3.png";
const analyticsFeature = "https://storage.googleapis.com/storage.magicpath.ai/component-assets/444810436261584896/444810436265779200/89d15ef0f80de29b8e21cbd9662f481866c95ecbf78a0b4bfc19d175a1f84ad6.png";
type Language = "ar" | "en";
const content = {
  ar: {
    ...
    heroBody: "من مسح رمز QR إلى شاشة الكاشير—يمنح DineHub ضيوفك قائمة سريعة بلا تسجيل، ويمنح فريقك إدارة كاملة للفروع والطلبات والتحليلات.",
    watch: "شاهد كيف يعمل",
    heroNote: "لا تطبيق. لا تسجيل. لا انتظار.",
    proof: [["بلا تسجيل", "للضيف"], ["فروع متعددة", "من لوحة واحدة"], ["عربي أولاً", "ومتجاوب بالكامل"]],
    ...
    steps: [["01", "امسح وابدأ", "يفتح الضيف القائمة فوراً من QR، من دون تنزيل تطبيق أو إنشاء حساب."], ["02", "خصّص براحتك", "إضافات، أحجام، ملاحظات خاصة مثل «بدون كاتشب»—كلها واضحة قبل الإرسال."], ["03", "تابع كل فرع", "تصل الطلبات للشاشة المناسبة، وتظهر المبيعات والأداء في لوحة إدارة واحدة."]],
    guestEyebrow: "للضيف والفريق",
    guestTitle: "واجهة سهلة على الجوال. وتشغيل قوي خلف الكواليس.",
    guestBody: "صممنا كل شاشة بحسب سياقها: أزرار مريحة للمس على جوال الضيف، تدفق سريع لشاشة الكاشير، وبيانات واضحة لصاحب المطعم.",
    ...
    features: [["قائمة مرنة", "أصناف، فئات، إضافات، توفر وأسعار خاصة بكل فرع."], ["طلبات مباشرة", "حالات واضحة وتنبيهات تساعد الفريق على التحرك بسرعة."], ["إدارة الفروع", "صلاحيات وإعدادات وقوائم مستقلة تحت حساب واحد."], ["تحليلات مفهومة", "اعرف الأصناف الأعلى طلباً وأوقات الذروة وأداء كل فرع."], ["مصمم للمس", "مساحات ضغط كبيرة وتجربة سريعة على الجوال وشاشة الكاشير."], ["جاهز للسوق السعودي", "عربي وRTL، ريال سعودي، ضريبة قيمة مضافة، وتجربة محلية أصيلة."]],
    saudiEyebrow: "مصمم للسوق السعودي",
    saudiTitle: "محلي في التفاصيل. عالمي في الإحساس.",
    saudiBody: "لغة عربية طبيعية، اتجاه RTL حقيقي، وعرض واضح للريال والضريبة—مع هوية حديثة بعيدة عن القوالب الحكومية المعتادة.",
    saudiTags: ["RTL أصلي", "ر.س", "ضريبة 15%", "فروع متعددة"],
    faqEyebrow: "أسئلة شائعة",
    faqTitle: "قبل أن تبدأ",
    faqs: [["هل يحتاج العميل إلى إنشاء حساب؟", "لا. يمسح الضيف رمز QR ويفتح القائمة ويخصص طلبه مباشرة من المتصفح."], ["هل يمكن تخصيص القائمة لكل فرع؟", "نعم. يمكنك التحكم بالأصناف والأسعار والتوفر والإضافات لكل فرع بشكل مستقل."], ["هل يعمل على شاشات الكاشير الصغيرة؟", "نعم. الواجهات متجاوبة ومصممة للمس، مع أزرار واضحة ومساحات ضغط مريحة."], ["هل يدعم العربية والضريبة؟", "نعم. التجربة عربية وRTL وتعرض الأسعار بالريال مع دعم إعدادات ضريبة القيمة المضافة."]],
  ...
  en: {
    ...
    heroBody: "From QR scan to cashier screen, DineHub gives guests an instant menu without signup—and gives your team complete control of branches, orders, and analytics.",
    ...
    steps: [["01", "Scan and start", "Guests open the QR menu instantly, with no app download or account creation."], ["02", "Make it yours", "Add-ons, sizes, and notes like “no ketchup” are clear before the order is sent."], ["03", "Run every branch", "Orders reach the right screen while sales and performance stay in one dashboard."]],
    guestEyebrow: "For guests and teams",
    guestTitle: "Effortless on mobile. Powerful behind the scenes.",
    guestBody: "Every screen fits its context: comfortable touch targets for guests, a fast cashier flow, and clear data for restaurant owners.",
    ...
    features: [["Flexible menu", "Items, categories, add-ons, availability, and branch-level pricing."], ["Live orders", "Clear statuses and alerts help the team move quickly."], ["Branch management", "Independent permissions, settings, and menus under one account."], ["Useful analytics", "Know your top items, rush hours, and branch performance."], ["Built for touch", "Large targets and fast flows on phones and cashier screens."], ["Saudi-ready", "Arabic and RTL, Saudi riyals, VAT, and a genuinely local experience."]],
    saudiEyebrow: "Built for Saudi Arabia",
    saudiTitle: "Local in the details. World-class in feel.",
    saudiBody: "Natural Arabic, true RTL, and clear SAR and VAT handling—wrapped in a distinctive identity that avoids familiar government templates.",
    saudiTags: ["Native RTL", "SAR", "15% VAT", "Multi-branch"],
    faqEyebrow: "FAQ",
    faqTitle: "Before you start",
    faqs: [["Does the customer need an account?", "No. Guests scan the QR code, open the menu, and customize their order directly in the browser."], ["Can each branch have its own menu?", "Yes. Control items, prices, availability, and add-ons independently for every branch."], ["Does it work on small cashier screens?", "Yes. Every interface is responsive and touch-friendly, with clear controls and comfortable targets."], ["Does it support Arabic and VAT?", "Yes. The experience supports Arabic, RTL, Saudi riyals, and configurable VAT settings."]],
...
const Check = () => <svg aria-hidden="true" viewBox="0 0 20 20" className="h-5 w-5 shrink-0 fill-none stroke-current" strokeWidth="2">
...
export const DineHubSaudiLandingPage = () => {
  ...
  return <div dir={rtl ? "rtl" : "ltr"} lang={language} className="min-h-screen overflow-x-hidden bg-[#fffaf3] text-[#191a35] antialiased selection:bg-[#ff6b4a]/25">
      ...
      <header className="sticky top-0 z-50 border-b border-[#191a35]/8 bg-[#fffaf3]/90 backdrop-blur-xl">
        <div className="mx-auto flex min-h-20 w-full max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
          ...
          <nav aria-label="Primary" className="hidden items-center gap-1 lg:flex">
            {t.nav.map((item, index) => <a key={item} href={t.navHref[index]} className="flex min-h-11 items-center rounded-xl px-4 text-sm font-semibold text-[#4d4e68] transition-colors duration-150 hover:bg-white hover:text-[#171831] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff6b4a]">
                {item}
              </a>)}
          </nav>
        ...
        {menuOpen && <div className="border-t border-[#191a35]/8 bg-[#fffaf3] px-4 pb-5 pt-3 lg:hidden">
            <nav className="mx-auto grid max-w-7xl gap-1">
              {t.nav.map((item, index) => <a key={item} href={t.navHref[index]} onClick={() => setMenuOpen(false)} className="flex min-h-12 items-center rounded-xl px-4 font-bold hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff6b4a]">{item}</a>)}
      ...
      <main id="top">
        <section className="relative isolate overflow-hidden pb-16 pt-10 sm:pb-24 sm:pt-16 lg:pb-28 lg:pt-20">
          ...
          <div className="mx-auto mt-14 grid w-[calc(100%-2rem)] max-w-5xl grid-cols-1 overflow-hidden rounded-[28px] bg-white shadow-[0_20px_60px_rgba(23,24,49,.09)] outline outline-1 outline-black/5 sm:grid-cols-3">
            {(t.proof as readonly (readonly [string, string])[]).map(([value, label], index) => <div key={value} className={`px-6 py-6 text-center ${index ? "border-t border-[#191a35]/8 sm:border-t-0 sm:border-e" : ""}`}>
        ...
        <section id="how" className="scroll-mt-24 bg-white py-20 sm:py-28">
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-14 grid gap-5 lg:grid-cols-3">
              ...
              return <article key={title} className="group relative overflow-hidden rounded-[32px] bg-[#fffaf3] p-5 shadow-[0_14px_40px_rgba(23,24,49,.07)] outline outline-1 outline-black/5 transition-[transform,box-shadow] duration-200 hover:-translate-y-1 hover:shadow-[0_22px_50px_rgba(23,24,49,.11)] sm:p-7">
          ...
          <div className="mx-auto grid w-full max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[.9fr_1.1fr] lg:px-8">
            <div>
              ...
              <div className="mt-8 grid gap-3">
                {(productTab === "guest" ? t.guestPoints : t.adminPoints).map(point => <div key={point} className="flex min-h-11 items-center gap-3 rounded-2xl bg-white px-4 py-3 font-bold text-[#353653] shadow-[0_5px_18px_rgba(23,24,49,.06)] outline outline-1 outline-black/5">
            ...
            <div className="rounded-[36px] bg-[#171831] p-3 shadow-[0_30px_70px_rgba(23,24,49,.2)] sm:p-5">
              ...
              <div className="min-h-[440px] rounded-[28px] bg-[#f8f3eb] p-4 sm:p-6">
                {productTab === "guest" ? <div className="mx-auto max-w-sm">
                    ...
                    <div className="mt-5 grid gap-3">
                      {[["برجر كلاسيك", "34 ر.س", "🍔"], ["تاكو دجاج", "28 ر.س", "🌮"], ["سلطة موسمية", "24 ر.س", "🥗"]].map(([name, price, emoji]) => <div key={name} className="flex min-h-20 items-center gap-3 rounded-[20px] bg-white p-3 shadow-[0_7px_20px_rgba(23,24,49,.07)]">
                    ...
                    <div className="mt-7 flex h-40 items-end gap-2 rounded-[22px] bg-white p-4 shadow-sm">
                      {[38, 55, 42, 70, 62, 86, 76, 96, 82, 100, 72, 91].map((height, i) => <div key={i} className="flex-1 rounded-t-md bg-[#7257d8]" style={{
                    height: `${height}%`,
                    opacity: .35 + i / 20
                  }} />)}
                    </div>
                    <div className="mt-4 grid gap-3 sm:grid-cols-3">
                      {[[t.orders, "142", "#ff6b4a"], ["متوسط الطلب", "42 ر.س", "#7257d8"], ["وقت الذروة", "8:30", "#12a6a0"]].map(([label, value, color]) => <div key={label} className="rounded-[20px] bg-white p-4 shadow-sm"><span className="mb-3 block h-2 w-8 rounded-full" style={{
                      backgroundColor: color
                    }} /><p className="text-xs font-bold text-[#858697]">{label}</p><p className="mt-1 text-xl font-black tabular-nums">{value}</p></div>)}
                    </div>
                  </div>}
              </div>
            </div>
        ...
        <section id="features" className="scroll-mt-24 bg-white py-20 sm:py-28">
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {(t.features as readonly (readonly [string, string])[]).map(([title, body], index) => <article key={title} className="rounded-[26px] bg-[#fffaf3] p-6 outline outline-1 outline-black/5 transition-[transform,box-shadow] duration-200 hover:-translate-y-0.5 hover:shadow-[0_15px_34px_rgba(23,24,49,.08)]">
        ...
        <section id="faq" className="scroll-mt-24 bg-white py-20 sm:py-28">
          <div className="mx-auto grid w-full max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[.65fr_1fr] lg:px-8">
            ...
            <div className="grid gap-3">
              {(t.faqs as readonly (readonly [string, string])[]).map(([question, answer]) => <details key={question} className="group rounded-[22px] bg-[#fffaf3] px-5 shadow-[0_6px_20px_rgba(23,24,49,.05)] outline outline-1 outline-black/5 open:shadow-[0_12px_28px_rgba(23,24,49,.08)]">
